...
var nicEditorConfig = bkClass.extend({
    ...
    iconsPath: "https://www.yiwubazaar.com/assets/images/nicEditIcons-latest.gif",
...
var nicEditorIFrameInstance = nicEditorInstance.extend({
    ...
    initFrame: function () {
        ...
        B.write(
            "<html><head>" +
                (A ? '<link href="' + A + '" rel="stylesheet" type="text/css" />' : "") +
...
var nicEditorSelect = bkClass.extend({
    construct: function (D, A, C, B) {
        ...
        this.txt = new bkElement("div")
            .setStyle({ overflow: "hidden", float: "left", width: "66px", height: "14px", marginTop: "1px", fontFamily: "sans-serif", textAlign: "center", fontSize: "12px" })
            .addClass("selectTxt")
            .appendTo(this.items);
        if (!window.opera) {
                ...
                switch (A) {
                    case "text":
                        this.inputs[itm] = new bkElement("input")
                            ...
                            .setStyle({ margin: "2px 0", fontSize: "13px", float: "left", height: "20px", border: "1px solid #ccc", overflow: "hidden" })
                            .setStyle(D.style)
                            .appendTo(B);
                        break;
                    case "select":
                        ...
                        for (opt in D.options) {
                            var E = new bkElement("option")
                                .setAttributes({ value: opt, selected: opt == F ? "selected" : "" })
            ...
            for (var F in D) {
                for (var E in D) {
                    ...
                    var B = new bkElement("DIV")
                        .setStyle({ backgroundColor: I, overflow: "hidden", width: "11px", height: "11px" })
...
var nicUploadButton = nicEditorAdvancedButton.extend({
    nicURI: "https://www.yiwubazaar.com/editor-image",
    ...
    addPane: function () {
        ...
        new bkElement("div").setStyle({ fontSize: "14px", fontWeight: "bold", paddingBottom: "5px" }).setContent("Insert an Imagee").appendTo(A);

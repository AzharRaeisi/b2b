(function ($) {
    ...
    $("#size-btn").on('click', function () {
        $("#size-section").append('' +
            ...
            '<input type="number" name="size_qty[]" class="input-field" value="" min="1">' +
            '</div>' +
            '<div class="col-md-4 col-sm-6">' +

            '<input type="number" name="size_price[]" class="input-field" value="" min="0">' +
            '</div>' +
            '</div>' +
            '</div>'
            + '');
    ...
    $("#color-btn").on('click', function () {
        ...
        $("#color-section").append('' +
            ...
            '<div class="col-md-4 col-sm-6">' +
            '<div class="input-group">' +
            '<input name="measure" type="text" class="input-field  form-control" placeholder="Add Photo">' +

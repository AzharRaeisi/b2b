...
.sub-categori .right-area .categori-item-area .item .item-img .extra-list ul li a,.product-details-page .right-area .product-info .product-size .siz-list li.active .box-login,
{
...
.video-play-btn {
  background-color: <?php echo $color; ?>;
    ...
    .product-details-page .right-area .product-info .product-price .price {
      color: <?php echo $color; ?>;}
        .product-details-page .right-area .product-info .product-size .siz-list li.active .box, .product-details-page .right-area .product-info .product-size .siz-list li.active .box-login {
          border: 1px solid <?php echo $color; ?>; }

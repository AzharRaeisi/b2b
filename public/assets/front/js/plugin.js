                                ...
                                o.preventDefault(),
                                    $(window).width() < 920 &&
                                        (e.hasClass("open")
                                            ...
                                            : (n.animated ? (e.addClass("open"), i.animateCss(e.find(".dropdown-menu").eq(0), n, n.animatedIn, !0)) : e.addClass("open"), $.isFunction(n.onOpenDropdown) && n.onOpenDropdown())),
                                    i.overlayDropdown();
                            }),
                            n.dropdownEvent)
                        ) {
                                        ...
                                        $(window).width() > 920 &&
                                            (e.hasClass("open")
                                                ? (n.animated
                                                  ...
                                                  $.isFunction(n.onCloseDropdown) && n.onCloseDropdown())
                                                : (e.closest("li").closest("ul").find(".open").removeClass("open"),
                                                  n.animated ? (e.addClass("open"), i.animateCss(e.find(".dropdown-menu").eq(0), n, n.animatedIn, !0)) : e.addClass("open"),
    ...
    d.extend(i.prototype, {
        ...
        _detailsObj: function (a) {
            ...
            return d.map(this.s.columns, function (e, d) {
                if (!e.never && !e.control) return { title: c.settings()[0].aoColumns[d].sTitle, data: c.cell(a, d).render(b.c.orthogonal), hidden: c.column(d).visible() && !b.s.current[d], columnIndex: d, rowIndex: a };
            });
        },
        _find: function (a) {
        ...
        listHiddenNodes: function () {
            return function (a, b, c) {
                ...
                d.each(c, function (b, c) {
                    c.hidden &&
                        (d('<li data-dtr-index="' + c.columnIndex + '" data-dt-row="' + c.rowIndex + '" data-dt-column="' + c.columnIndex + '"><span class="dtr-title">' + c.title + "</span> </li>")

...
Route::get('/cover-prices', 'Front\FrontendController@converPrices');
...
Route::group(['middleware'=>'maintenance'],function(){
    ...
    //Route::get('', 'Front\FrontendController@index')->name('front.home');
    /*Route::get('/extras', 'Front\FrontendController@extraIndex')->name('front.extraIndex');*/ //For getting home page as ajax
    ...
    Route::get('/set-search','Front\CatalogController@setSearch')->name('front.setSearch');

    /*CATEGORY SECTION*/
    Route::get('/products/{category?}/{subcategory?}/{childcategory?}','Front\CatalogController@category')->name('front.category');
    Route::get('/products/{slug1}/{slug2}','Front\CatalogController@subcategory')->name('front.subcat');
    Route::get('/products/{slug1}/{slug2}/{slug3}','Front\CatalogController@childcategory')->name('front.childcat');
    Route::get('/all-categories/','Front\CatalogController@categories')->name('front.categories');
    Route::get('/childcategories/{slug}', 'Front\CatalogController@childcategories')->name('front.childcategories');
    /*CATEGORY SECTION ENDS*/

    /*CATEGORY SECTION*/

    Route::get('/services/{category?}/{subcategory?}/{childcategory?}','Front\CatalogController@service')->name('front.service');
    Route::get('/services/{slug1}/{slug2}','Front\CatalogController@subcategory')->name('front.subcat-service');
    Route::get('/services/{slug1}/{slug2}/{slug3}','Front\CatalogController@childcategory')->name('front.childcat-service');
    Route::get('/all-services/','Front\CatalogController@categories')->name('front.services');
    Route::get('/childcatservices/{slug}', 'Front\CatalogController@childcategories')->name('front.childcategories-service');
    /*CATEGORY SECTION ENDS*/

    /*Suppliers Page*/
    Route::get('/all-suppliers/','Front\CatalogController@suppliers')->name('front.suppliers');
    ...
    /*Route::get('/item/quick/view/{id}/','Front\CatalogController@quick')->name('product.quick');*/ //Removed by imran
    ...
    /*VENDOR SECTION*/
    Route::get('/supplier/{shop_name}','Front\VendorController@index')->name('front.vendor');
    Route::get('/suppliers/{category_id?}/{sub_category_id?}/{child_category_id?}','Front\VendorController@stores')->name('front.vendorStores');
    ...
    /*PAGE SECTION*/
    Route::get('cms/{slug}','Front\FrontendController@page')->name('front.page');
    /*PAGE SECTION ENDS*/

    Route::get('/featured-suppliers','Front\FrontendController@featuredSuppliers')->name('front.featuredCatSuppliers');
    Route::get('/featured-products','Front\FrontendController@featuredProducts')->name('front.featuredCatproducts');
    Route::get('/featured-services','Front\FrontendController@featuredServices')->name('front.featuredCatService');

    /*Request a qoute section*/
    Route::get('/all-orders', 'Front\FrontendController@allQuotes')->name('front.allQuotes');
    Route::get('/request-quote', 'Front\FrontendController@requestQuote')->name('front.requestQuote');
    Route::post('/request-quote-post', 'Front\FrontendController@requestQuotePost')->name('front.requestQuotePost');
    /*Route::get('/get-quotes', 'Front\FrontendController@getQuotes')->name('front.getQuotes');*/

    Route::post('editor-image', 'Front\FrontendController@editorImage');
    /************************************* FRONT SECTION ENDS***********************************************/

    Route::group(['prefix'=>'vendor','middleware' => ['vendorOnly']], function(){
        ...
        Route::post('/profile-password-update', 'Vendor\VendorController@passwordUpdate')->name('vendor-password-update');
        // Vendor Profile Ends

        Route::group(['middleware'=>'activeVendor'],function(){
    ...
    Route::group(['prefix'=>'user'], function(){
        ...
        Route::get('/warning/user/{id}', 'User\UserController@warningVerify')->name('user-warning');
        Route::post('/user-verify', 'User\UserController@verifysubmit')->name('user-verify-submit');
...
Route::prefix('yiwu-bazar-mgmt')->group(function() {
    ...
    Route::group(['middleware'=>'permissions:products'],function(){
        ...
        // EDIT SECTION
        Route::get('/products/duplicate/{id}', 'Admin\ProductController@duplicate')->name('admin-prod-duplicate');
        Route::post('/products/duplicate/post/{id}', 'Admin\ProductController@duplicatePost')->name('admin-prod-duplicate-post');
        // EDIT SECTION ENDS
    ...
    Route::group(['middleware'=>'permissions:vendors'],function(){
        ...
        Route::get('/buyer-verificatons/datatables/{status}', 'Admin\VerificationController@bvDatatables')->name('admin-bv-datatables');
        Route::get('/buyers-verificatons', 'Admin\VerificationController@buyersIndex')->name('admin-bv-index');
        Route::get('/buyers-verificatons/pendings', 'Admin\VerificationController@buyersPending')->name('admin-bv-pending');
    ...
    Route::group(['middleware'=>'permissions:home_page_settings'],function(){
        ...
        Route::get('/feature-brands', 'Admin\PartnerController@index')->name('admin-partner-index');
    ...
    //------------ ADMIN Buyer Requests SECTION ------------
    Route::group(['middleware'=>'permissions:buyer_requests'],function(){

        Route::get('/buyers_requests/datatables', 'Admin\RequestsAQuoteController@datatables')->name('admin-brequests-datatables'); //JSON REQUEST
        Route::get('/buyers_requests', 'Admin\RequestsAQuoteController@index')->name('admin-brequests-index');

        Route::get('/buyers_requests-reject', 'Admin\RequestsAQuoteController@indexReject')->name('admin-brequests-reject');
        Route::get('/buyers_requests-approved', 'Admin\RequestsAQuoteController@indexApproved')->name('admin-brequests-approved');
        Route::get('/buyers_requests-delete/{id}', 'Admin\RequestsAQuoteController@buyerRequestDelete')->name('admin-brequests-delete');
        Route::get('/buyers_request-detail/{id}', 'Admin\RequestsAQuoteController@detail')->name('admin-brequests-detail');
        Route::get('/buyers_request-status/{id}/{status}', 'Admin\RequestsAQuoteController@statusUpdate')->name('admin-brequests-statusUpdate');
    });
    //------------ ADMIN Buyer Requests ENDS ------------
    ...
    Route::group(['middleware'=>'permissions:super'],function(){
        ...
        Route::get('cache/clear', 'Admin\DashboardController@adminCacheClear')->name('admin-cache-clear');
    ...
    Route::get('/vendor-dashboard', 'dashboardvendorController@index');

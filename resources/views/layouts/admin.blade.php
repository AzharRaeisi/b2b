...
<head>
    ...
    @else
        ...
        <link href="{{asset('assets/admin/css/style.css?v1.1.0')}}" rel="stylesheet"/>
        <link href="{{asset('assets/admin/css/custom.css?v1.1.2')}}" rel="stylesheet"/>
...
<script src="{{asset('assets/admin/js/nicEdit.js?v2.0.2')}}"></script>
...
<!-- AJAX Js-->
<script src="{{asset('assets/admin/js/myscript.js?v1.1.1')}}"></script>

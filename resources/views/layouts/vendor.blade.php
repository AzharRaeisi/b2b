                                ...
                                <div class="dropdown-menu">
                                    <div class="dropdownmenu-wrapper">
                                        <ul>
                                            ...
                                            <li>
                                                <a target="_blank" href="{{ route('front.vendor',Auth::user()->shop_name) }}"><i class="fas fa-eye"></i> {{ $langg->lang432 }}</a>
                                            </li>
                                            <li>
...
<!-- AJAX Js-->
<script src="{{asset('assets/vendor/js/myscript.js?v1.1.1')}}"></script>
@yield('scripts')
<script>
...
toastr.success('{!!\Session::get('success')!!}');
        ...
        @foreach ($errors->all() as $resErrors)
toastr.error('{!! $resErrors !!}');
        @endforeach
        @endif
        @if(!empty(session()->get('status_message')))
            toastr.error('{!! session()->get('status_message') !!}');
        @endif
    })
</script>
</body>

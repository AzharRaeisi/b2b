                            ...
                            <div class="login-area signup-area">
                                ...
                                <div class="login-form signup-form">
                                    ...
                                    <form class="mregisterform" action="{{route('user-register-submit')}}" method="POST">
                                        ...
                                        <div class="form-input">
                                            <input type="text" class="User Name" name="zip" placeholder="Zip">
                                            <i class="icofont-location-pin"></i>
                                        </div>
                                        <div class="form-input">
                                            <input type="text" class="User Name" name="city" placeholder="City">
                                            <i class="icofont-location-pin"></i>
                                        </div>
                                        ...
                                        @if($gs->is_capcha == 1)
                                            <ul class="captcha-area">
                                                <li>
                                                    <p><img class="codeimg1" src="{{asset("assets/images/capcha_code.png?".time())}}" alt=""> <i class="fas fa-sync-alt pointer refresh_code "></i></p>
                                                </li>
                                            </ul>
                                            <div class="form-input">
...
<!--
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-input">
                                                <label>Please attach your identity documents e.g. passport or national id card.</label>
                                            </div>

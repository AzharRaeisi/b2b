                        ...
                        <div class="row row-cards-one">
                            <div class="col-md-12">
                                <div class="alert alert-danger validation text-center">
                                    <h3>{{ $user->displayWarning() }} </h3> <a href="{{ route('user-warning',$user->verifies()->where('admin_warning','=','1')->orderBy('id','desc')->first()->id) }}"> {{$langg->lang803}} </a>
                                </div>
                            </div>
                        </div>
                    @endif
...
-->
							<div class="mycard bg1">
								<div class="left">
								  <h5 class="title">{{ isset($langg->lang809) ? $langg->lang809 : 'Total Orders' }} </h5>
								  <span class="number">{{ Auth::user()->orders()->where('status','completed')->count() }}</span> <a href="{{url('/user/orders')}}" class="link">View All</a> </div>
...
-->
							<div class="mycard bg2">
								<div class="left">
								  <h5 class="title">{{ isset($langg->lang810) ? $langg->lang810 : 'Pending Orders' }} </h5>
								  <span class="number">{{ Auth::user()->orders()->where('status','pending')->count() }}</span> <a href="{{url('/user/orders')}}" class="link">View All</a> </div>
								<div class="right d-flex align-self-center">
								  <div class="icon"> <i class="icofont-dollar"></i> </div>
								</div>
							  </div>

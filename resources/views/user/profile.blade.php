                            ...
                            <div class="edit-info-area">
                                ...
                                <div class="body">
                                    <div class="edit-info-area-form">
                                        ...
                                        <form id="userform" action="{{route('user-profile-update')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
                                            ...
                                            <div class="upload-img">
                                                @if($user->is_provider == 1)
                                                    <div class="img"><img src="{{ $user->photo ? asset($user->photo):asset('assets/images/'.$gs->user_image) }}"></div>
                                                @else
                                                    <div class="img"><img src="{{ $user->photo ? asset('assets/images/users/'.$user->photo):asset('assets/images/'.$gs->user_image) }}"></div>
                                                @endif
                                                @if($user->is_provider != 1)

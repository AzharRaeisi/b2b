<li>
    <a href="#buyers_requests" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fas fa-hand-holding-usd"></i>{{ __('Buyer requests') }}</a>
    <ul class="collapse list-unstyled" id="buyers_requests" data-parent="#accordion" >
        <li>
            <a href="{{route('admin-brequests-index')}}"> {{ __('Pending Buyer requests') }}</a>
        </li>
        <li>
            <a href="{{route('admin-brequests-reject')}}"> {{ __('Rejected Buyer requests') }}</a>
        </li>
        <li>
            <a href="{{route('admin-brequests-approved')}}"> {{ __('Approved Buyer requests') }}</a>
        </li>
    </ul>
</li>
<li>
...
<li>
    <a href="#menu3" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
        <i class="icofont-user"></i>{{ __('Buyers') }}
    </a>
    <ul class="collapse list-unstyled" id="menu3" data-parent="#accordion">
        <li>
            <a href="{{ route('admin-user-index') }}"><span>{{ __('Buyers List') }}</span></a>
        </li>
        {{--<li>
            <a href="{{ route('admin-withdraw-index') }}"><span>{{ __('Withdraws') }}</span></a>
        </li>--}}
        <li>
            <a href="{{ route('admin-user-image') }}"><span>{{ __('Buyers Default Image') }}</span></a>
        </li>
    </ul>
</li>
<li>
    <a href="#buyers1" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
        <i class="icofont-verification-check"></i>{{ __('Buyers Verifications') }}
    </a>
    <ul class="collapse list-unstyled" id="buyers1" data-parent="#accordion">
        <li>
            <a href="{{ route('admin-bv-index') }}"><span>{{ __('All Verifications') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-bv-pending') }}"><span>{{ __('Pending Verifications') }}</span></a>
        </li>
    </ul>
</li>
<li>
...
<li>
    ...
    <ul class="collapse list-unstyled" id="homepage" data-parent="#accordion">
        ...
        <li>
            <a href="{{ route('admin-sb-index') }}"><span>{{ __('Top Banner') }}</span></a>
        </li>
        {{--<li>
            <a href="{{ route('admin-sb-large') }}"><span>{{ __('Large Banners') }}</span></a>
        </li>--}}
        <li>
            <a href="{{ route('admin-sb-bottom') }}"><span>{{ __('Bottom Banner') }}</span></a>
        </li>
        ...
        <li>
            <a href="{{ route('admin-partner-index') }}"><span>{{ __('Featured Brands') }}</span></a>
        </li>
...
<li>
    <a href="#otherTools" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
        <i class="fas fa-wrench"></i>{{ __('Other Settings') }}
    </a>
    <ul class="collapse list-unstyled" id="otherTools" data-parent="#accordion">

        <li>
            <a href="#blog" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false" style="color: #1f2d41;float: left;display: inline-block;width: 100%;">
        ...
        <li>
            <a href="#emails" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false" style="color: #1f2d41;float: left;display: inline-block;width: 100%;">
        ...
        <li>
            <a href="#socials" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false" style="color: #1f2d41;float: left;display: inline-block;width: 100%;">
                <i class="fas fa-paper-plane"></i>{{ __('Social Settings') }}
            </a>
            <ul class="collapse list-unstyled" id="socials">
        ...
        <li>
            <a href="#seoTools" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false" style="color: #1f2d41;float: left;display: inline-block;width: 100%;">
        ...
        <li>
            <a href="{{ route('admin-cache-clear') }}" class=" wave-effect" style="color: #1f2d41;float: left;display: inline-block;width: 100%;"><i class="fas fa-sync"></i>{{ __('Clear Cache') }}</a>
        </li>
    </ul>
</li>

            ...
            <div class="service-center">
                ...
                <div class="body-area">
                    <ul class="list">
                        ...
                        @endif--}}
                        <li class="seller-info" style="box-shadow: 0px 0px #fff !important;background: none;">
                            <a class="text-light view-stor" href="{{route('front.requestQuote')}}" target="_blank">
                                Get a Quote
                            </a>
                        </li>
                    </ul>
                ...
                @if(!empty($vendor->f_check) ||!empty($vendor->g_check) ||!empty($vendor->t_check) ||!empty($vendor->l_check))

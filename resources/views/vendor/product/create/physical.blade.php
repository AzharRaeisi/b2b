...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Add Product') }} <a class="add-btn" href="{{ route('vendor-prod-types') }}"><i
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('vendor-prod-physical-create') }}">{{ __('Product') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <form id="yiwuform" action="{{route('vendor-prod-store')}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="row">
                <div class="col-lg-8">
                                    ...
                                    <div class="body-area">
                                        ...
                                        <div class="showbox">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input class="form-control" placeholder="Digit only: 0" type="number" value="" name="minimum_quantity">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">

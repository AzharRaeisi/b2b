...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __("Add Service") }} <a class="add-btn" href="{{ route('vendor-prod-types') }}"><i
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('vendor-prod-digital-create') }}">{{ __("Add Service") }}</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <form id="yiwuform" action="{{route('vendor-prod-store')}}" method="POST"

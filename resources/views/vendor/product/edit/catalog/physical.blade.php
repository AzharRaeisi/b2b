								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
										  ...
										  <form id="yiwuform" action="{{route('vendor-prod-catalog-update',$data->id)}}" method="POST" enctype="multipart/form-data">
											{{csrf_field()}}
...
// Gallery Section Insert
  ...
  $("#uploadgallery").change(function(){
     ...
     for(var i=0;i<total_file;i++)
     {
      ...
      $('#yiwuform').append('<input type="hidden" name="galval[]" id="galval'+i+'" class="removegal" value="'+i+'">')
     }

    ...
    @if(Session::has('cart'))
        <div class="dropdownmenu-wrapper">
            ...
            <ul class="dropdown-cart-products">
                @foreach(Session::get('cart')->items as $keyIndex=>$product)
                    <li class="product cremove{{ $product['item']['id'].$keyIndex}}">
                        ...
                        <figure class="product-image-container">
                            ...
                            <div class="cart-remove" data-class="cremove{{ $product['item']['id'].$keyIndex}}" data-href="{{ route('product.cart.remove',$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])) }}" title="Remove Product">

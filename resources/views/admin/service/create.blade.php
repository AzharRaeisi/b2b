                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="yiwuformdata" action="{{route('admin-service-create')}}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Home Page Image') }} *</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="home_page_link" placeholder="{{ __('Link') }}" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="feature_banner_link" placeholder="{{ __('Link') }}" value="">
                                    </div>
                                </div>

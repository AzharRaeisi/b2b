					...
					<div class="product-description">
						...
						<div class="body-area">
							...
							<div class="row form-group m-1 show-img-gallery">
								...
								<!-- <div class="col-lg-2 col-md-2">
									<div class="panel panel-body show-img-gallery">
										<div class="span4 cropme text-center" style="min-height:122px; border: 1px dashed #ddd; background: #f1f1f1;box-shadow: 2px 4px 5px #ddd;">
											...
											<div class="row px-3 ">
												...
												<div class="col-md-4 col-sm-6">
													<div class="input-group">
														<input name="add_photo" type="text" class="input-field  form-control" placeholder="{{ __('Add Photo') }}">
...
<script type="text/javascript">
	...
	// 	// alert(URL.createObjectURL(event.target.files));
	// 	// for (var i = 0; i < total_file; i++) {
	// 	// 	$('.show-img-gallery').append('<div class="col-sm-6">' +

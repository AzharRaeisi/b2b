											...
											<div class="row px-3 ">
												...
												<div class="col-md-4 col-sm-6">
													<div class="input-group">
														<input name="measure" type="file" class="input-field  form-control" placeholder="{{ __('Add Photo') }}">
													...
													<div class="row">
														<div class="col-md-3 col-sm-4">
															...
															<div class="input-group mb-3">
																<input type="text" name="wieight[]" value="" style="padding: 12px 15px;" placeholder="Weight" class="form-control" />
											...
											<div class="row px-3 d-flex">
												<div class="col-lg-4 p-0 ">
													<div class="checkbox-wrapper d-flex align-items-center justify-content-start ">
														<input class="form-check mr-2" type="checkbox" value="" name="payment_terms[]">
														<label for="allowProductMinimumQuantity">{{ __('Cash on Delivery (COD)') }}</label>
													</div>
												</div>
												<div class="col-lg-4 p-0">
													<div class="checkbox-wrapper d-flex align-items-center justify-content-start ">
														<input class="form-check mr-2" type="checkbox" value="" name="minimum_quantity">
										...
										<div class="offset-lg-1 col-lg-2">
											<div class="col-lg-12 p-0">
												<div class="checkbox-wrapper">
													...
													<h4 class="heading" style="font-size:1rem; font-weight:400px;">{{ __('Supply Ability') }}</h4>
												</div>
											</div>
										</div>
										<div class="col-lg-8">
									...
									<div class="row">
										...
										<div class="col-lg-4">
											<div class="row px-3 d-flex">
												<div class="col-lg-2">
													<div class="checkbox-wrapper d-flex align-items-center justify-content-start ">
														<input class="form-check mr-2 chk" type="checkbox" value="" name="sample_check">
									...
									<div class="row">
										...
										<div class="col-lg-8">
											<div class="row d-flex">
												...
												<div class="col-lg-4">
													<div class="checkbox-wrapper d-flex align-items-center justify-content-start ">
														<input class="form-check mr-2" type="checkbox" value="" name="export_market[]">

						...
						<div class="col-lg-12">
							<div class="product-description product-basic-info ">
								...
								<div class="body-area">
									...
									<!--  meta tag design -->
									<div class="container m-auto pb-1" style="background-color: #F0F0F0;">
				...
				<div class="add-product-content my-4 product-desc">
					<div class="product-description">
						...
						<div class="body-area">
							...
							<input type="hidden" id="uploadgallery" name="photo[]" value="" accept="image/*" multiple>
							...
							<div class="row inline-flex">
								...
								<div class="col-lg-12">
									<div class="row">
										<div class="offset-lg-1 col-lg-2">
											<div class="left-area">
												<h4 class="heading" style="font-size:1rem; font-weight:400px;">Maximum Order Quantity</h4>
											</div>
										</div>
										...
										<div class="col-lg-8">
											<div class="row">
												...
												<div class="col-lg-6 mt-3">
													<select id="product_measure" name="unit_measurement">
												...
												<div class="col-lg-6 mt-3 " id="measure">
													<input name="measure" type="text" id="measurement" class="input-field" placeholder="{{ __('Unit of Measurement') }}">
												</div>
											</div>
										</div>
									</div>
											...
											<div class="row px-2 ">
												...
												<div class="col-md-4 col-sm-6">
													<div class="input-group">
														<input name="measure" type="text" class="input-field  form-control" placeholder="{{ __('Add Photo') }}">
														...
														<div class="size-area">
															...
															<div class="row px-3">
																...
																<div class="col-md-4 col-sm-6 input-group">
																	...
																	<input type="number" name="size_price[]" class="input-field form-control" placeholder="Price - eg. 02.20" value="Price - eg. 02.20" min="0">
										...
										<div class="col-lg-9">
											...
											<div class="row">
												...
												<div class="col-lg-6 mt-3 hidden">
													<input name="measure" type="text" class="input-field" placeholder="{{ __('Enter Unit') }}">
												</div>
											</div>
										</div>
									</div>
											...
											<div class="row d-flex">
												<div class="col-lg-4 p-0 ">
													<div class="checkbox-wrapper d-flex align-items-center justify-content-start ">
														<input class="form-check mr-1" type="checkbox" value="" name="payment_terms[]">
														<label for="allowProductMinimumQuantity">{{ __('Cash on Delivery (COD)') }}</label>
													</div>
												</div>
												<div class="col-lg-4 p-0">
													<div class="checkbox-wrapper d-flex align-items-center justify-content-start ">
														<input class=" checkclick1 mr-1" type="checkbox" value="" name="minimum_quantity">
										...
										<div class="col-lg-4">
											<div class="row d-flex">
												<div class="col-lg-2 p-0 ">
													<div class="checkbox-wrapper d-flex align-items-center justify-content-start ">
														<input class="form-check mr-1 chk" type="checkbox" value="" name="sample_check">
														<label for="allowProductMinimumQuantity">{{ __('Yes') }}</label>
													</div>
												</div>
												<div class="col-lg-2 p-0">
													<div class="checkbox-wrapper d-flex align-items-center justify-content-start ">
														<input class=" checkclick1 mr-1 chk" type="checkbox" value="" name="sample_check">
										...
										<div class="col-lg-9">
											<div class="row d-flex">
												...
												<div class="col-lg-1 p-0 ">
													<div class="checkbox-wrapper d-flex align-items-center justify-content-start ">
														<input class="form-check mr-1" type="checkbox" value="" name="export_market[]">
														<label for="allowProductMinimumQuantity">{{ __('Asia') }}</label>
													</div>
												</div>
												<div class="col-lg-2 p-0">
													<div class="checkbox-wrapper d-flex align-items-center justify-content-start ">
														<input class=" checkclick1 mr-1" type="checkbox" value="" name="export_market[]">

...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading">{{ __("Add Service") }} <a class="add-btn"
				...
				<ul class="links">
					...
					<li>
						<a href="{{ route('admin-prod-digital-create') }}">{{ __("Add Service") }}</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<form id="yiwuform" action="{{route('admin-prod-store')}}" method="POST" enctype="multipart/form-data">
									{{csrf_field()}}
	<div class="row">
		<div class="col-lg-8">
						...
						<div class="product-description">
							<div class="body-area">
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="left-area">
												<h4 class="heading">{{ __("Service Previous Price") }}*</h4>

                            ...
                            <div class="col-lg-12">
                                <div class="product-description product-basic-info">
                                    ...
                                    <div class="body-area">
                                        ...
                                        <div class="{{ $data->product_condition == 0 ? "showbox":"" }}" style="display: none">
...
<div class="row text-center">
                ...
                <div class="col-lg-12 mt-4 product-details">

                    <div class="add-product-content mt-0">
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="body-area">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-12 col-sm-12">
                                                ...
                                                <div class="panel panel-body">
                                                    <div class="span4 cropme text-center" id="landscape" style="width: 50%; min-height: 255px; border: 1px dashed #ddd; background: #f1f1f1;">
										...
										<div class="row from-group">
											<div class="col-lg-4 col-md-4 col-12 col-sm-6">
												<div class="left-area float-right">
<!--
													<h4 class="heading"><span class="label-star">*</span>{{ __('Product Gallery Images') }} </h4>
-->
													
												</div>
											</div>
											<div class="col-lg-8 col-md-8 col-12 col-sm-6 mb-2">
                                        ...
                                        <div class="row form-group">
											<div class="col-lg-4 col-md-4 col-12 col-sm-12 d-none">
													<div class="left-area text-right">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-12 col-sm-12 m-auto">
                                                <div class="text-editor">
                                    ...
                                    <div class="body-area">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-lg-3 col-md-3 col-12 col-sm-12">
													<div class="left-area text-right">
														<h4 class="heading"><span class="label-star">*</span>{{ __('Unit') }} </h4>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    <select id="product_measure">
                                                        ...
                                                        <option value="Pair" {{$data->measure == 'Pair' ? 'selected':''}}>Pair</option>
                                                        <option value="" {{ in_array($data->measure,explode(',', 'Gram,Kilogram,Litre,Pound','Pair')) ? '' : 'selected' }}>{{ __('Custom') }}</option>
                                                    </select>
                                                </div>
                                                <div class="col-lg-3 col-md-3 {{ in_array($data->measure,explode(',', 'Gram,Kilogram,Litre,Pound','Pair')) ? 'hidden' : '' }}" id="measure">
                                                    <input name="measure" type="text" id="measurement" class="input-field" placeholder="" value="{{$data->measure}}">
                                                </div>
                                            </div>
                                            <div class="row form-group">
												<div class="col-lg-3 col-md-3 col-12 col-sm-12">
													<div class="left-area text-right">
														<h4 class="heading"><span class="label-star">*</span>{{ __('MOQ') }} </h4>
														
													</div>
												</div>
                                                <div class="col-lg-4 col-md-4 col-12 col-sm-12">
													<div class="minimum-quant">
														<input class="form-control" placeholder="" type="number" value="{{$data->minimum_quantity}}" name="minimum_quantity">
													</div>
												</div>
                                            ...
                                            <div class="row form-group">
												<div class="col-lg-3 col-md-3 col-12 col-sm-12">
													<div class="left-area text-right">
														<h4 class="heading"><span class="label-star">*</span>{{ __('Product Stock') }} </h4>
														<p class="sub-heading">{{ __('(Leave Empty will Show Always Available)') }}</p>
														
													</div>
												</div>
												<div class="col-lg-4 col-md-4 col-12 col-sm-12">
														<input name="stock" type="text" class="input-field" placeholder="" value="{{ $data->stock }}">
												</div>
											</div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3 col-md-3 col-12">
                                                    <div class="left-area text-right">
														<h4 class="heading"><span class="label-star">*</span>{{ __('Product Whole Sell') }} </h4>
                                                    </div>
                                                </div>
                                                <div class="col-lg-9 col-md-9 col-12">
                                                    <div class="featured-keyword-area featured-keyword-area-edit">
                                                        <div class="feature-tag-top-filds" id="whole-section">
                                                            @if(!empty($data->whole_sell_qty))
                                                                @foreach($data->whole_sell_qty as $key => $data1)
                                                                    <div class="feature-area">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-6">
                                                                                <input type="text" name="whole_sell_qty[]" class="input-field"  placeholder="" value="{{ $data->whole_sell_qty[$key] }}" required="">
                                                                            </div>

                                                                            <div class="col-lg-6">
                                                                                <input type="text" name="whole_sell_discount[]" class="input-field" placeholder="" value="{{ ($data->whole_sell_discount[$key]*$sign->value) }}" required="">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                @endforeach
                                                            @else
                                                                <div class="feature-area">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <input type="text" name="whole_sell_qty[]" class="input-field " placeholder="">
                                                                        </div>

                                                                        <div class="col-lg-6 ">
                                                                            <input type="text" name="whole_sell_discount[]" class="input-field" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-end mt-4">
													<a href="javascript:;" id="whole-btn" class="add-fild-btn add-more" style="margin:unset;"><i class="icofont-plus"></i> {{ __('Add More Field') }}</a>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                @if(!empty($data->color))
                                                    <div  class="col-lg-3 col-md-3 col-12 col-sm-12">
														<div class="left-area text-right">
															<h4 class="heading"><span class="label-star">*</span>{{ __('Product Colors') }} </h4>
															<p class="sub-heading">
                                                            ...
                                                            @foreach($data->color as $key => $data1)
                                                                <div class="color-area">
                                                                    ...
                                                                    <div class="input-group colorpicker-component cp">
                                                                        ...
                                                                        <span class="input-group-addon h-100"><i></i></span>
                                                                    </div>
                                                                </div>
                                                            @endforeach 
                                                        </div>
													</div>
													<div class="col-lg-12 col-md-12 col-12 col-sm-12 d-flex justify-content-end">
														<div class="add-more-color">
															<a href="javascript:;" id="color-btn" class="add-more  m-0"><i
                                                ...
                                                @else
														...
														<div  class="col-lg-12 col-md-12 col-12 col-sm-12 d-flex justify-content-end">
															<div class="add-more-color">
																<a href="javascript:;" id="color-btn" class="add-more  mb-3"><i class="fas fa-plus"></i>{{ __('Add More Color') }} </a>
															</div>
														</div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3 col-md-3 col-12 col-sm-12">
													<div class="left-area float-right">
														<h4 class="heading"><span class="label-star">*</span>{{ __('Product Sizes') }} </h4>
														
													</div>
												</div>
                                                <div  class="col-lg-9 col-md-9 col-12 pr-4">
                                                    <div class="product-size-details pb-0" id="size-section">
                                                        @if(!empty($data->size))
                                                                ...
                                                                <div class="size-area">
                                                                    ...
                                                                    <div  class="row">
                                                                        <div class="col-md-4 col-sm-6">
                                                                            ...
                                                                            <input type="text" name="size[]" class="input-field" placeholder="" value="{{ $data->size[$key] }}">
                                                                        </div>
                                                                        <div class="col-md-4 col-sm-6">
                                                                            <label>
                                                                                {{ __('Size Qty') }} :
                                                                            ...
                                                                            <input type="number" name="size_qty[]" class="input-field" placeholder="" min="1" value="{{ $data->size_qty[$key] }}">
                                                                        </div>
                                                                        <div class="col-md-4 col-sm-6">
                                                                            <label>
                                                                                {{ __('Size Price') }} :
                                                                            ...
                                                                            <input type="number" name="size_price[]" class="input-field" placeholder="" min="0" value="{{ $data->size_price[$key] }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            @endforeach
                                                            ...
                                                            <div class="size-area">
                                                                ...
                                                                <div  class="row">
                                                                    <div class="col-md-4 col-sm-6">
                                                                        ...
                                                                        <input type="text" name="size[]" class="input-field" placeholder="">
                                                                    </div>
                                                                    <div class="col-md-4 col-sm-6">
                                                                        <label>
                                                                            {{ __('Size Qty') }} :
                                                                        ...
                                                                        <input type="number" name="size_qty[]" class="input-field" placeholder="" value="" min="1">
                                                                    </div>
                                                                    <div class="col-md-4 col-sm-6">
                                                                        <label>
                                                                            {{ __('Size Price') }} :
                                                                        ...
                                                                        <input type="number" name="size_price[]" class="input-field" placeholder="" value="" min="0">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        @endif
                                                ...
                                                <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-end mt-4">
													 <a href="javascript:;" id="size-btn" class="add-more" style="margin: unset;"><i class="fas fa-plus"></i>{{ __('Add More Size') }} </a>
                                                </div>
                                            </div>
                                            <div class="row form-group">
												<div class="col-lg-3 col-md-3 col-12 col-sm-12">
													<div class="left-area text-right">
														<h4 class="heading"><span class="label-star">*</span>{{ __('Product Estimated Shipping Time') }} </h4>
														
													</div>
												</div>
                                                
                                                <div class="col-lg-4 col-md-4 col-12 col-sm-12">
													<div class="product-est-time">
														<input type="text" class="input-field" placeholder="" name="ship" value="{{ $data->ship == null ? "" : $data->ship }}">
													</div>
                                                </div>
                                            </div>
   </div>                                         
<!--
                                            <div class="row form-group">
												<div class="col-lg-4 col-md-4 col-12 col-sm-12">
													<div class="left-area text-right">
														<h4 class="heading"><span class="label-star">*</span>{{ __('Product Minimum Quantity Type') }} </h4>
                                                ...
                                                <div class="col-lg-8 col-md-8 col-12 col-sm-12">
													<div class="minimum-quant">
														<input class="form-control" placeholder="Ex: piece, tons etc.." type="text" value="{{$data->minimum_qty_type}}" name="minimum_qty_type">
													</div>
                                                </div>
                                            </div>
-->
...
<!--
                                        <div class="row form-group">
											<div class="col-lg-4 col-md-4 col-12 col-sm-12">
												<div class="left-area text-right">
															<h4 class="heading"><span class="label-star">*</span>{{ __('Product Current Price') }} </h4>
															<p class="sub-heading">
															({{ __('In') }} {{$sign->name}})
														</p>
                                        ...
                                        <div class="row form-group">
											<div class="col-lg-4 col-md-4 col-12 col-sm-12">
													<div class="left-area text-right">
														<h4 class="heading"><span class="label-star">*</span>{{ __('Product Previous Price') }} </h4>
...
-->
										...
										<div class="row">
                                            <div class="col-lg-12 text-center pb-5">
                                                <button class="addProductSubmit-btn" style="background: #1f224f;width: 170px;height: 46px;color: #fff;font-size: 16px;border-radius: 20px;border: 0px;margin-top: 15px;-webkit-transition: all 0.3s ease-in;transition: all 0.3s ease-in;"type="submit">{{ __('Save') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>

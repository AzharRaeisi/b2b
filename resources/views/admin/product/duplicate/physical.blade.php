...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading"> {{ __('Duplicate Product') }} <a class="add-btn" href="{{ url()->previous() }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                    <ul class="links">
                        <li>
                        ...
                        <li>
                            <a href="javascript:;">{{ __('Duplicate') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <form id="yiwuform" action="{{route('admin-prod-duplicate-post',$data->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="product-description">
                                    <div class="body-area">
                                                        ...
                                                        <div class="feature-tag-top-filds" id="whole-section">
                                                            @if(!empty($data->whole_sell_qty))
                                                                @foreach($data->whole_sell_qty as $key => $data1)
                                                                    <div class="feature-area">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-6">
                                                                                <input type="text" name="whole_sell_qty[]" class="input-field"  placeholder="1-100" value="{{ $data->whole_sell_qty[$key] }}" required="">
                                                                            </div>

                                                                            <div class="col-lg-6">
                                                                                <input type="text" name="whole_sell_discount[]" class="input-field" placeholder="2.99" value="{{ $data->whole_sell_discount[$key] }}" required="">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                @endforeach
                                                            @else
                                                                <div class="feature-area">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <input type="text" name="whole_sell_qty[]" class="input-field" placeholder="1-100">
                                                                        </div>

                                                                        <div class="col-lg-6">
                                                                            <input type="text" name="whole_sell_discount[]" class="input-field" placeholder="2.99" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <select id="product_measure">
                                                        ...
                                                        <option value="Custom" {{ in_array($data->measure,explode(',', 'Gram,Kilogram,Litre,Pound','Pair')) ? '' : 'selected' }}>{{ __('Custom') }}</option>
                                                    </select>
                                                </div>
                                                <div class="col-lg-6 {{ in_array($data->measure,explode(',', 'Gram,Kilogram,Litre,Pound','Pair')) ? 'hidden' : '' }}" id="measure">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="checkbox-wrapper">
                                                    <input type="checkbox" name="minimum_quantity_check" class="checkclick" id="allowProductMinimumQuantity" value="1" {{!empty($data->minimum_quantity)?'checked':''}}>
                                                    <label for="allowProductMinimumQuantity">{{ __('Allow Product Minimum Quantity') }}</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="{{!empty($data->minimum_quantity)?'':'showbox'}}">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="left-area">
                                                        <h4 class="heading">{{ __('Product Minimum Quantity') }}*</h4>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <input class="form-control" placeholder="Digit only: 0" type="number" value="{{$data->minimum_quantity}}" name="minimum_quantity">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-12">
                                <div class="product-description">
                                    <div class="body-area">
                                        ...
                                        <input type="hidden" id="feature_photo" name="photo" value="data:image/jpg;base64,{{base64_encode(file_get_contents(url('assets/images/products/'.$data->photo)))}}" accept="image/*">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="left-area">
                                                    <h4 class="heading">
                                            ...
                                            <div class="col-lg-12">
                                                <a href="javascript" class="set-gallery set-gallery-duplicate"  data-toggle="modal" data-target="#setgallery">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", ".set-gallery-duplicate" , function(){
                        ...
                        for(var k in arr)
                        {
                            if(arr[k]['type'] == 'image'){
                                $('.selected-image .row').append('<div class="col-sm-6">'+
                                    ...
                                    '<input type="hidden" name="duplicate-gallery-images[]" value="'+arr[k]['photo']+'">'+
                                    '</span>'+
            ...
            $('.set-gallery-duplicate').removeClass('set-gallery-duplicate');
        });

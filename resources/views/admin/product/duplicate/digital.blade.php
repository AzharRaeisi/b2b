...
@section('content')
	<div class="content-area">
		<div class="mr-breadcrumb">
			<div class="row">
				<div class="col-lg-12">
					<h4 class="heading"> {{ __("Duplicate Product") }} <a class="add-btn" href="{{ url()->previous() }}"><i
					...
					<ul class="links">
						...
						<li>
							<a href="{{ url()->previous() }}">{{ __("Duplicate") }}</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<form id="yiwuform" action="{{route('admin-prod-duplicate-post',$data->id)}}" method="POST"
							...
							<div class="col-lg-12">
								<div class="product-description">
									<div class="body-area">
										...
										<input type="hidden" id="feature_photo" name="photo" value="data:image/jpg;base64,{{ base64_encode(file_get_contents(public_path('assets/images,'.$data->photo))) }}">

        ...
        <div class="body-area">
          <div class="row">
            <div class="col-lg-12">
              ...
              <form id="yiwuform" action="{{ route('admin-ps-homeupdate') }}" method="POST"
                ...
                <div class="row justify-content-center" style="display: none !important;">
                  <div class="col-lg-4 d-flex justify-content-between">
                  ...
                  <div class="col-lg-4 d-flex justify-content-between" style="display: none !important;">

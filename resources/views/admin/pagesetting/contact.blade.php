                  ...
                  <div class="col-lg-12">
                    <div class="product-description">
                      <div class="body-area">
                        ...
                        <form id="yiwuform" action="{{ route('admin-ps-update') }}" method="POST" enctype="multipart/form-data">
                          {{ csrf_field() }}
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="row justify-content-center">
                              ...
                              <div class="col-lg-6">
                                  <div class="tawk-area">
									  <textarea class="form-control" id="summernote" name="contact_title"> {{ $data->contact_title }} </textarea>
<!--
...
-->
                          ...
                          <div class="row justify-content-center">
                              ...
                              <div class="col-lg-6">
                                  <div class="tawk-area">
									  <textarea class="form-control" id="summernote" name="contact_text"> {{ $data->contact_text }} </textarea>
<!--
...
-->
                          ...
                          <div class="row justify-content-center">
                              ...
                              <div class="col-lg-6">
                                  <div class="tawk-area">
									  <textarea class="form-control" id="summernote" name="contact_success"> {{ $data->contact_success }} </textarea>
<!--
...
-->
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="row justify-content-center">
                              ...
                              <div class="col-lg-6">
                                  <div class="tawk-area">
									  <textarea class="form-control" id="summernote" name="street"> {{ $data->street }} </textarea>
<!--

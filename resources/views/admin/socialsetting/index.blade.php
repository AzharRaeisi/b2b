    ...
    <div class="add-product-content1">
      <div class="product-description">
        <div class="body-area">
          ...
          <form id="yiwuform" class="form-horizontal" action="{{ route('admin-social-update-all') }}" method="POST">
            {{ csrf_field() }}
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <input class="form-control" name="instagram" id="instagram" placeholder="{{ __('http://instagram.com/') }}" type="text" value="{{$data->instagram}}">
              </div>
            </div>
            <div class="row">
              <label class="control-label col-sm-3" for="linkedin">{{ __('Youtube') }} *</label>
              <div class="col-sm-6">
                <input class="form-control" name="youtube" id="youtube" placeholder="{{ __('http://youtube.com/') }}" type="text" value="{{$data->youtube}}">
              </div>
            </div>

...
@section('content')
	<div class="content-area" style="padding-left: 0;padding-top: 100px;">
				...
				<div class="col-lg-12">
					<div class="product-description">
						<div class="body-area">
							...
							<form id="yiwuformdata" action="{{route('admin-vendor-verify-submit',$data->id)}}" method="POST" enctype="multipart/form-data">
								{{csrf_field()}}
								<div class="row">
									<div class="col-lg-4">
										<div class="left-area">

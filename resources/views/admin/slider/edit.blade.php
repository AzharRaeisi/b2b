                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="yiwuform" action="{{route('admin-sl-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="img-upload full-width-img">
                                            ...
                                            <p class="text">{{ __('Prefered Size: (1400x500) or Square Sized Image') }}</p>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="btext" placeholder="{{ __('Button Text') }}" value="{{$data->btext}}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('User For') }}*</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <select class="form-control" name="use_for" id="use_for" required>
                                            <option value="Website" {{ $data->use_for == 'Website' ? 'selected':'' }}>Website</option>
                                            <option value="Application" {{ $data->use_for == 'Application' ? 'selected':'' }}>Mobile Application</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">

                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="yiwuform" action="{{route('admin-sl-create')}}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="btext" placeholder="{{ __('Button Text') }}" value="SHOP NOW">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <select class="form-control" name="use_for" id="use_for" required>
                                            ...
                                            <option value="Application">Mobile Application</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">

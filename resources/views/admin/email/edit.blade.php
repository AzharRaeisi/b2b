                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="yiwuform" action="{{route('admin-mail-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
							  <textarea class="form-control" id="summernote" placeholder="{{ __('Email Body') }}" name="email_body">{{ $data->email_body }}</textarea>
<!--

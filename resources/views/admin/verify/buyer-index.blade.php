...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __("Bueyrs Verifications") }}</h4>
                    <ul class="links">
                        <li>
                            <a href="{{ route('admin.dashboard') }}">{{ __("Dashboard") }} </a>
                        </li>
                        <li><a href="javascript:;">{{ __('Bueyrs Verifications') }}</a></li>
                        <li>
                            <a href="{{ route('admin-bv-index') }}">{{ __("All Verifications") }}</a>
                        </li>
                    </ul>
                </div>
            </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var table = $('#yiwutable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin-bv-datatables','all') }}',
            columns: [
                { data: 'name', name: 'name' },

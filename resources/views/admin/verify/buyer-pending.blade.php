...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __("Buyer Pending Verifications") }}</h4>
                    <ul class="links">
                        <li>
                            <a href="{{ route('admin.dashboard') }}">{{ __("Dashboard") }} </a>
                        </li>
                        <li><a href="javascript:;">{{ __('Buyer Verifications') }}</a></li>
                        <li>
                            <a href="{{ route('admin-vr-index') }}">{{ __("Buyer Pending Verifications") }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="table-responsiv">
                            <table id="yiwutable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th>{{ __("Text") }}</th>
                                    <th>{{ __("Status") }}</th>
                                    <th style="width: 215px;">{{ __("Options") }}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var table = $('#yiwutable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin-bv-datatables','Pending') }}',
            columns: [
                { data: 'name', name: 'name' },

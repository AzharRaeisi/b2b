                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="yiwuform" action="{{route('admin-page-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
							  <textarea class="form-control" id="summernote" placeholder="{{ __('Description') }}" name="details">{{ Request::old('details') }}</textarea>
<!--

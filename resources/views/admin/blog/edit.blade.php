                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="yiwuform" action="{{route('admin-blog-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
							  <textarea class="form-control" id="summernote" placeholder="{{ __('Details') }}" name="details">{{ $data->details }}</textarea>
<!--

                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="yiwuformdata" action="{{route('admin-sb-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="img-upload full-width-img">
                                            ...
                                            <p class="text">
                                                @if($data->id == '7')
                                                    Prefered Size: (436x566)
                                                @elseif($data->id == '6')
                                                    Prefered Size: (1370x240)
                                                @elseif($data->id == '9')
                                                    Prefered Size: (437x647)
                                                @elseif($data->id == '2')
                                                    Prefered Size: (1520x60)
                                                @else
                                                    Prefered Size: (1280x600)
                                                @endif
                                            </p>
                                        </div>

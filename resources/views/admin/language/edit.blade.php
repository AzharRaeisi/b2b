                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="yiwuform" action="{{route('admin-lang-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                            ...
                                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                                ...
                                                <h4 class="text-center">Site pages</h4>

                                                <hr>
												@foreach($new_words as $new_word)
                                                    @php
                                                        $new_slug = slugify2($new_word);
                                                    @endphp
												<div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="left-area">
                                                            <h4 class="heading">{{$new_word}}*</h4>
                                                            <p class="sub-heading">(In Any Language)</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" placeholder="{{$new_word}}" name="{{$new_slug}}" value="{{ !empty($lang->$new_slug) ? $lang->$new_slug : $new_word }}" required="">
                                                    </div>
                                                </div>
												@endforeach
                                            </div>

...
@section('content')
    <div class="content-area"> @include('includes.form-success')
        ...
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __("Dashboard") }}</h4>
                    <ul class="links">
                        <li> <a href="{{ route('admin.dashboard') }}">Main Dashboard Area </a> </li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-12 col-lg-6 col-xl-4">
                        <div class="mycard bg1">
                            <div class="left">
                                ...
                                <span class="number">{{count($pending)}}</span> <a href="{{route('admin-order-pending')}}" class="link">{{ __('View All') }}</a> </div>
                    ...
                    <div class="col-md-12 col-lg-6 col-xl-4">
                        <div class="mycard bg2">
                            <div class="left">
                                ...
                                <span class="number">{{count($processing)}}</span> <a href="{{route('admin-order-processing')}}" class="link">{{ __('View All') }}</a> </div>
                            <div class="right d-flex align-self-center">
                    ...
                    <div class="col-md-12 col-lg-6 col-xl-4">
                        <div class="mycard bg3">
                            <div class="left">
                                ...
                                <span class="number">{{count($completed)}}</span> <a href="{{route('admin-order-completed')}}" class="link">{{ __('View All') }}</a> </div>
                            <div class="right d-flex align-self-center">
                    ...
                    <div class="col-md-12 col-lg-6 col-xl-4">
                        <div class="mycard bg4">
                            <div class="left">
                                ...
                                <span class="number">{{count($products)}}</span> <a href="{{route('admin-prod-index')}}" class="link">{{ __('View All') }}</a> </div>
                            <div class="right d-flex align-self-center">
                    ...
                    <div class="col-md-12 col-lg-6 col-xl-4">
                        <div class="mycard bg5">
                            <div class="left">
                                ...
                                <span class="number">{{count($users)}}</span> <a href="{{route('admin-user-index')}}" class="link">{{ __('View All') }}</a> </div>
                            <div class="right d-flex align-self-center">
                    ...
                    <div class="col-md-12 col-lg-6 col-xl-4">
                        <div class="mycard bg6">
                            <div class="left">
                                ...
                                <span class="number">{{count($blogs)}}</span> <a href="{{ route('admin-blog-index') }}" class="link">{{ __('View All') }}</a> </div>
                            <div class="right d-flex align-self-center">
                                ...
                                <table class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                    ...
                                    @foreach($rorders as $data)
                                        <tr>
                                            ...
                                            <td><div class="action-list"><a href="{{ route('admin-order-show',$data->id) }}"><i
                                                                class="fas fa-eye"></i> {{ __('Details') }}</a> </div></td>
                                        </tr>
                                    @endforeach
                                    </thead>
                                ...
                                <table class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                    ...
                                    @foreach($rusers as $data)
                                        <tr>
                                            ...
                                            <td><div class="action-list"><a href="{{ route('admin-user-show',$data->id) }}"><i
                                                                class="fas fa-eye"></i> {{ __('Details') }}</a> </div></td>
                                        </tr>
                                    @endforeach
                                    </thead>
                                    ...
                                    @foreach($poproducts as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->category->name }}
                                                @if(isset($data->subcategory)) <br>
                                                {{ $data->subcategory->name }}
                                                @endif
                                                @if(isset($data->childcategory)) <br>
                                                {{ $data->childcategory->name }}
                                                @endif </td>
                                            <td>{{ $data->type }}</td>
                                            <td> {!! $data->showPrice() !!} </td>
                                            <td><div class="action-list"><a href="{{ route('admin-prod-edit',$data->id) }}"><i
                                                                class="fas fa-eye"></i> {{ __('Details') }}</a> </div></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                ...
                                <table id="pproducts" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                    ...
                                    @foreach($pproducts as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->type }}</td>
                                            <td> {!! $data->showPrice() !!} </td>
                                            <td><div class="action-list"><a href="{{ route('admin-prod-edit',$data->id) }}"><iclass="fas fa-eye"></i> {{ __('Details') }}</a> </div></td>
                                        </tr>
                                    @endforeach
                                    </tbody>

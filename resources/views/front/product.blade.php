...
@section('title',$productt->name)
@section('page-styles')
<style>
    .wholesell-details-page .table td,
    .wholesell-details-page .table th {
        padding: 5px;
    }
</style>
@endsection
...
<link rel="stylesheet" type="text/css" href="https://www.yiwubazaar.com/assets/front/css/xzoom.css" media="all" />
                            ...
                            <div class="xzoom-thumbs">
                                <div class="all-slider">
                                    ...
                                    {{--<video width="320" height="240" controls>
                                                    <source src="{{asset('assets/images/galleries/'.$gal->photo)}}" type="video/mp4">
                                    Your browser does not support the video tag.
                                    </video>--}}
                                    <a href="javascript:void(0)">
                                        <img class="" width="80" src="{{ asset('assets/front/images/video_play.png') }}" title="" onclick="alert('{{$gal->photo}}')">
                                    </a>
                                    @else
                                    <a href="{{asset('assets/images/galleries/'.$gal->photo)}}">
                                        <img class="xzoom-gallery5" style="width: 133px;height: 133px;" src="{{asset('assets/images/galleries/'.$gal->photo)}}" title="">
                                    </a>
                                    @endif
                                    @endforeach
                                    @if(!empty($productt->add_photo_color))
                                    @foreach($productt->add_photo_color as $gal_color => $data2)
                                    <a href="{{asset('assets/images/galleries/'.$productt->add_photo_color[$gal_color])}}" id="img_{{ $gal_color }}">
                                        <img class="xzoom-gallery5" style="width: 133px;height: 133px;" src="{{asset('assets/images/galleries/'.$productt->add_photo_color[$gal_color])}}" title="">
                                    </a>
                                    @endforeach
                                    @endif
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="right-area">
                            <div class="product-info">
                                ...
                                <p class="p-sku">
                                    Product ID: <span class="idno">{{ sprintf("%'.08d",$productt->id) }}</span>
                                </p>
                                @endif
                                ...
                                <div class="product-price">
                                    ...
                                    <p class="title">{{ $productt->size_price[0] }}</p>

                                    <!-- <p class="price"><span id="sizeprice">{!! $productt->showPrice() !!}</span>
                                            <small><del>{!! $productt->showPreviousPrice() !!}</del></small>
                                            @if($productt->minimum_quantity && $productt->minimum_quantity > 1 && auth()->guard('web')->check() && auth()->guard('web')->user()->IsUser() && auth()->guard('web')->user()->IsActive())
                                                <span style="font-size: 12px;color: #5a5b5d;">{{$productt->minimum_quantity}} (Min. order)</span>
                                            @endif
                                        </p> -->
                                ...
                                <div class="product-size">
                                    ...
                                    <ul class="siz-list">
                                        ...
                                        <li class="{{ $is_first ? 'active' : '' }}">
                                            <span class="{{ auth()->guard('web')->check() && auth()->guard('web')->user()->IsUser() && auth()->guard('web')->user()->IsActive() ?'box':'box-login'}}">{{ $data1 }}
                                ...
                                <div class="product-color">
                                    ...
                                    <ul class="color-list">
                                        ...
                                        <li class="{{ $is_first ? 'active' : '' }}" id="color_{{ $key }}">
                                ...
                                <div class="info-meta-3">
                                    <ul class="meta-list">
                                        ...
                                        <div class="table-area wholesell-details-page">
                                            ...
                                            <table class="table" style="width: 80%">
                                                ...
                                                <tr>
                                                    ...
                                                    <!-- <td>{{--<del>{!! $productt->showPrice() !!}</del>--}}
                                                                    @if(auth()->guard('web')->check() && auth()->guard('web')->user()->IsUser() && auth()->guard('web')->user()->IsActive())
                                                                        {{ $curr->sign }}{!! number_format($productt->whole_sell_discount[$key]*$curr->value,2) !!} {{--% {{ $langg->lang771 }}--}}
                                                                    @else
                                                                        <a href='{{route('user.login')}}' style='display: inline-block;font-size: 14px;float: left'>View price</a>
                                                                    @endif
                                                                </td> -->
                                                    <td>
                                        ...
                                        <li class="d-inline-block count {{ $productt->type == 'Physical' ? '' : 'd-none' }}">
                                            <div class="qty">
                                                <ul>
                                                    <li>
                                                        <span class="qtminus" data-min="{{empty($productt->minimum_quantity)?'1':$productt->minimum_quantity}}">
                                                            <i class="icofont-minus"></i>
                                                        </span>
                                                    </li>
                                                    <li>
                                                        <span class="qttotal">{{ !empty($productt->minimum_quantity)?$productt->minimum_quantity:'1' }}</span>
                                                        <input type="number" value="{{ !empty($productt->minimum_quantity)?$productt->minimum_quantity:'1' }}" id="edit_qty_text" style="display: none;width: 50px;padding: 2px;border: 1px solid rgba(144, 144, 144, 0.4);" autocomplete="off">
                                                    </li>
                                                    <li>
                                                        <span class="qtplus">
                                        ...
                                        <li class="addtocart">
                                            <a href="{{route('front.requestQuote')}}" target="_blank">Get a Quote</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="seller-info">
                            ...
                            <div class="contact-seller">
                                ...
                                <ul class="list">
                                    ...
                                    <a class="favorite-prod view-stor" data-href="{{ route('user-favorite',['data1' => Auth::guard('web')->user()->id, 'data2' => $productt->user->id]) }}" href="javascript:;">
                                        <i class="icofont-plus"></i>
                                        {{ $langg->lang224 }}
                                    </a>
                                    ...
                                    {{--<li>
                                                    <a  class="vziew-stor" href="javascript:;" data-toggle="modal" data-target="#vendorform1">
                                                        <i class="icofont-ui-chat"></i>
                                                        {{ $langg->lang81 }}
                                    </a>
                                    </li>--}}
                                    <li>
                                        <a class="view-stor" href="{{route('front.requestQuote')}}" target="_blank">
                                            Get a Quote
                                        </a>
                                    </li>
                                    @else
                        ...
                        <div id="product-details-tab">
                            <div class="top-menu-area">
                                <ul class="tab-menu">
                                    ...
                                    @endif
                                    <!--<li><a href="#tabs-5">Seller Info</a></li>-->
                                </ul>
                            </div>
                                ...
                                <div id="tabs-3" class="tab-content-area">
                                    ...
                                    <div id="replay-area">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <br>
                                                <h5 class="text-center"><a href="javascript:;" data-toggle="modal" data-target="#comment-log-reg" class="btn btn-danger text-light mr-1 ">{{ $langg->lang101 }}</a> {{ $langg->lang102 }}</h5>
                                                <br>
                                            </div>
                                        </div>
                                        @endif
...
-->
    ...
    <div class="trending">
        <div class="container">
            ...
            <div class="row row_trending" style="margin-bottom: 35px;">
                <div class="col-lg-12 remove-padding">
            ...
            <div class="row row_trending" style="margin-bottom: 35px;">
                <div class="col-lg-12 remove-padding">
                    <div class="trending-item-slider">
                        @foreach($productt->category->products()->where('status','=',1)->where('id','!=',$productt->id)->inRandomOrder()->get() as $prod)
                        @php
                        $prod->user_id = 0;
                        @endphp
                        @include('includes.product.slider-product')

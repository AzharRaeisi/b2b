...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'feature_page_banner'       => 'required|mimes:jpeg,jpg,png,svg',
        ];
        ...
        if ($file = $request->file('feature_page_banner'))
        {
            $name = time().'-banner-'.$file->getClientOriginalName();
            $file->move('assets/images/services',$name);
            $input['feature_page_banner'] = $name;
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        $rules = [
            ...
            'feature_page_banner'       => 'mimes:jpeg,jpg,png,svg',
        ...
        if ($file = $request->file('feature_page_banner'))
        {
            $name = time().'-banner-'.$file->getClientOriginalName();
            $file->move('assets/images/services',$name);
            if(!empty($data->feature_page_banner)) {
                if (file_exists(public_path().'/assets/images/services/'.$data->feature_page_banner)) {
                    unlink(public_path().'/assets/images/services/'.$data->feature_page_banner);
                }
            }
            $input['feature_page_banner'] = $name;
        }

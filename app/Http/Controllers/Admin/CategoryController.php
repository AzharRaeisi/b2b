...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(!empty($input['featured_for_products'])){
            $input['featured_for_products'] = '1';
        }else{
            $input['featured_for_products'] = '0';
            $input['products_sort_order'] = '0';
        }
        if(empty($input['products_sort_order'])){
            $input['products_sort_order'] = '0';
        }

        if(!empty($input['featured_for_services'])){
            $input['featured_for_services'] = '1';
        }else{
            $input['featured_for_services'] = '0';
            $input['services_sort_order'] = '0';
        }
        if(empty($input['services_sort_order'])){
            $input['services_sort_order'] = '0';
        }

        if(!empty($input['featured_for_suppliers'])){
            $input['featured_for_suppliers'] = '1';
        }else{
            $input['featured_for_suppliers'] = '0';
            $input['suppliers_sort_order'] = '0';
        }
        if(empty($input['suppliers_sort_order'])){
            $input['suppliers_sort_order'] = '0';
        }
